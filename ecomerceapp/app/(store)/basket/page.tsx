    ...
    const handleCheckout = async () => {
        ...
        try {
            const metadata: Metadata = {
                ...
                customerName: user?.fullName ?? "Desconhecido",
                customerEmail: user?.emailAddresses[0].emailAddress ?? "Desconhecido",
                clerkUserId: user!.id,
            };
    ...
    <div className="container mx-auto p-4 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
                <h3 className="text-xl font-semibold">Resumo da compra</h3>
                ...
                {isSignedIn ? (
                    <button
                        ...
                        {isLoading ? "Processando...": "Pagamento"}
                    </button>
                ): (
                    <SignInButton mode="modal">
                        <button className="mt-4 w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                            Cadastre para o pagemento
                        </button>
                    </SignInButton>
                )}
            </div>
